...
request_max_latitude_start_validator = MaxValueValidator(Decimal('82.0'), message='Request latitude start must be less then 82.0')
...
request_max_longitude_validator = MaxValueValidator(Decimal('359.9'), message='Request longitude stop must be less then 359.9')
